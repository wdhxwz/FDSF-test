...
public class TestClient1
{
  ...
  {
  	String conf_filename = "fdfs_client.properties";
  	...
  	try
  	{
  		...
  		*/
  		...
  		if ((file_id=client.upload_file1(local_filename, null, meta_list)) != null)
  		{
  			...
  			errno = client.download_file1(file_id, 0, 100, "C:\\Users\\Administrator\\Desktop\\kkk.jpg");
  			if (errno == 0)
  			{
  			...
  			errno = client.download_file1(file_id, new DownloadFileWriter("C:\\Users\\Administrator\\Desktop\\kkk.jpg"));
  			if (errno == 0)
  			{
  				System.err.println("Download file success");
  			}
